...
class TokenizedCardsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        LayoutInflater.from(parent.context).inflate(R.layout.all_tokenized_card_items, parent, false)
        )
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is TokenizedCardsViewHolder -> {
                holder.bind(generateQrcodeResponse[position])
            }
        }
    }
    ...
    class TokenizedCardsViewHolder(
        ...
        private var saveQrButton = itemView.findViewById<AppCompatButton>(R.id.save_qr_on_device_btn)
        ...
        fun bind(generateQrcodeResponse: GenerateQrcodeResponse) {
